...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all transactions for the logged-in user' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of transactions returned' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new transaction (admin or POS use)' }),
