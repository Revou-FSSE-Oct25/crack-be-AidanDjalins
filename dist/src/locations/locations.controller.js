...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all location coordinates' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of locations returned' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add a location (admin only)' }),
